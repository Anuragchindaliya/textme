...
const dynamicForm = createSlice({
  ...
  reducers: {
    ...
    setIsTourActive(state,{payload:{isTourActive}}:PayloadAction<{isTourActive:boolean}>){
...
export const selectIsTourActive = (state: RootState) => state.dynamicForm.isTourActive
