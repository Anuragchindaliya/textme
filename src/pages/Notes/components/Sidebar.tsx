    ...
    <Sheet>
      ...
      <SheetContent side={"left"}>
        <SheetHeader>
          ...
          <aside>
            {/* <aside
              // className="fixed top-0 left-0 z-40 w-64 h-screen pt-14 transition-transform -translate-x-full bg-white border-r border-gray-200 md:translate-x-0 dark:bg-background dark:border-gray-700"
              aria-label="Sidenav"
          ...
          <SheetFooter className="mt-auto block">
            <div className=" absolute bottom-0 left-0 justify-center p-4 space-x-4 w-full lg:flex  z-20">
              ...
              <Button
                ...
                variant="ghost"
                className="w-9 px-0"
                // className="inline-flex justify-center p-2 text-primary rounded cursor-pointer bg-secondary-foreground dark:text-foreground dark:hover:text-white   hover:bg-primary/20 dark:hover:bg-gray-600"
              >
                {/* <Share2 /> */}
                {hasCopied ? <Check /> : <Share2 />}
              </Button>
              <ModeToggle />
              {/* <div
                id="tooltip-settings"
