  ...
  const tools = [
    {
      title: "Share Content",
      description:
        "Quickly broadcast notes, files, or copy links to colleagues instantly.",
      icon: Share2,
      link: "/share-content",
      category: "Utility",
      badge: "Fast Share",
    },
    {
      title: "QR Code Suite",
      description:
        "Generate static/dynamic QR codes, scan via webcam, or upload QR images.",
      icon: QrCode,
      link: "/qrcode",
      category: "Utility",
      badge: "Dynamic QR",
    },
    {
      title: "Draw & Sketch",
      description:
        "Infinite vector whiteboard canvas to sketch mockups, draw flowcharts, or export layouts.",
      icon: MousePointer,
      link: "/draw",
      category: "Creative",
      badge: "Whiteboard",
    },
    {
      title: "Family Tree",
      description:
        "Visualize family lineages and hierarchies using customizable nodes.",
      icon: Users,
      link: "/family-tree",
    ...
    },
    {
      title: "Form Builder",
      description:
        "Drag-and-drop form creator to build, preview, and collect responses.",
    ...
    },
    {
      ...
      description:
        "Markdown-capable text editor with code highlight blocks and checklist structures.",
      icon: Edit3,
      link: "/editor",
      category: "Creative",
      badge: "Rich Doc",
    },
    {
      ...
      description:
        "Manage milestones, tasks, and scheduling inside an interactive monthly grid.",
      icon: Calendar,
      link: "/calendar",
      category: "Productivity",
      badge: "Scheduler",
    },
    {
      title: "Map & Location",
      description:
        "Plot custom coordinates, view map tiles, and track navigation parameters.",
      icon: MapPin,
      link: "/location",
      category: "Visualization",
      badge: "Geospatial",
    },
    {
      title: "Plan Tax",
      description:
        "Financial modeling workspace to calculate tax margins and log plans.",
      icon: Calculator,
      link: "/calculate-tax",
      category: "Productivity",
      badge: "Finance",
    },
    {
      ...
      description:
        "Extract txt data from local images or documents in seconds using optical characters.",
      icon: ScanLine,
      link: "/ocr",
      category: "Utility",
      badge: "OCR Engine",
    },
    {
      ...
      description:
        "Create premium billing invoices and export compliant PDF layouts directly.",
    ...
    },
    {
      ...
      description:
        "Browse commercial items, manage shopping carts, and structure product catalogs.",
      icon: ShoppingBag,
      link: "/products",
      category: "Productivity",
      badge: "Catalog",
    },
    {
      title: "Task Manager",
      description:
        "Organize workflows, track to-dos, and change tasks statuses via status checkboards.",
      icon: CheckSquare,
      link: "/task",
      category: "Productivity",
      badge: "Tasks List",
    },
    {
      ...
      description:
        "Direct shortcuts and unified directory mapping for active government portals.",
      icon: LinkIcon,
      link: "/gov-link",
      category: "Utility",
      badge: "Directory",
    },
    {
      ...
      description:
        "Visual node flows using React Flow to plan component dependency graphs.",
      icon: Workflow,
      link: "/react-flow",
      category: "Visualization",
      badge: "Flow Canvas",
    },
    {
      title: "Weather App",
      description:
        "Track weather metrics, view city temperatures, and check rain forecasts.",
      icon: CloudRain,
      link: "/weather",
      category: "Utility",
      badge: "Live Forecast",
    },
    {
      title: "AI Playground",
      description:
        "Test prompt generation and check autonomous LLM responses side-by-side.",
      icon: Sparkles,
      link: "/ai-playground",
    ...
    },
    {
      title: "PDF Editor",
      description:
        "Upload PDFs, edit text contents, rearrange layouts, and export final revisions.",
      icon: FileSignature,
      link: "/pdf-editor",
      category: "Creative",
      badge: "PDF Annotator",
  ...
  const showcaseStories = [
    {
      ...
      description:
        "Designed for architects, designer leads, and software developers. The drawing workspace enables vector shapes, freehand brushes, path alignments, and high-quality image exports in one click. Fully integrated with state-persistence so you never lose your draft notes.",
      features: [
        "Infinite canvas grid panning",
        "Vector shapes & brushes",
        "PNG/SVG export modules",
        "Auto-saves canvas history",
      ],
      color:
        "from-purple-500/20 to-indigo-500/20 dark:from-purple-900/10 dark:to-indigo-950/10",
    ...
    },
    {
      ...
      description:
        "A premium document composer right inside your browser. Write in formatted markdown, inject collapsible checklists, structure technical code syntaxes with syntax-highlight highlights, and export clean TXT files for your local workspace.",
      features: [
        "Inline block formatting",
        "Code syntax rendering",
        "Toggle checklists & lists",
        "Zero external database delays",
      ],
      color:
        "from-blue-500/20 to-cyan-500/20 dark:from-blue-900/10 dark:to-cyan-950/10",
    ...
    },
    {
      ...
      description:
        "An intuitive builder workspace. Drag and drop form controls (inputs, checkboxes, radio selections, dates), construct custom label elements, preview generated form instances in real time, and easily download compiled JSON response lists.",
      features: [
        "Drag-and-drop form creator",
        "Schema validator generator",
        "Response database summaries",
        "Interactive preview modes",
      ],
      color:
        "from-emerald-500/20 to-teal-500/20 dark:from-emerald-900/10 dark:to-teal-950/10",
    ...
    },
    {
      ...
      description:
        "Unifies modern large language prompts in a responsive testing window. Draft prompts, customize parameters, log AI response logs side-by-side, and immediately isolate results to copy to notes worksheets.",
      features: [
        "Prompt templates library",
        "Interactive response boxes",
        "Redux parameter caching",
        "One-click copy exports",
      ],
      color:
        "from-amber-500/20 to-orange-500/20 dark:from-amber-900/10 dark:to-orange-950/10",
    ...
    <div className="relative min-h-screen pb-16 bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 transition-colors duration-300">
      ...
      <section className="relative z-10 pt-16 md:pt-24 pb-12 px-4 sm:px-6 lg:px-8 text-center">
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          >
            Simplify your workflow with a unified layout. Create notes, compose
            docs, plan events, draw vectors, scan OCR layers, generate invoices,
            and sandbox AI inputs.
          </motion.p>
                ...
                >
                  ...
                  <div className="p-6 space-y-4 flex-1 flex flex-col justify-between">
                    ...
                    <div className="pt-4 border-t border-slate-100 dark:border-slate-800/60 flex items-center justify-between mt-auto">
                      <span className={theme.classes.badgeMuted}>
                        {tool.category}
                      </span>
        ...
        {filteredTools.length === 0 && (
          <div className="text-center py-16 space-y-3">
            <p className="text-slate-400 dark:text-slate-600 text-sm">
              No utility tools match your search criteria.
            </p>
            <button
              onClick={() => {
                setSearchQuery("")
      ...
      >
        <div className="text-center space-y-3 max-w-xl mx-auto mb-16">
          ...
          <p className={theme.typography.body}>
            Scroll down to review the core utility tools, designed with
            high-efficiency layout blocks and reactive states.
          </p>
        </div>
            ...
            >
              ...
              <div className="flex-1 space-y-6">
                ...
                <div className="space-y-3">
                  ...
                  <p className={theme.typography.body}>{story.description}</p>
                </div>
                ...
                <div className="pt-2">
                  <Link
                    to={
                      tools.find((t) =>
                        t.title.toLowerCase().includes(story.id),
                      )?.link || "/"
                    }
      ...
      <footer className="relative z-10 max-w-4xl mx-auto px-4 text-center pt-16 mt-16 border-t border-slate-200/40 dark:border-slate-900/40">
        <p className="text-xs text-slate-400 dark:text-slate-600 font-mono">
          Designed and engineered as a Premium Web Work suite. All rights
          reserved.
        </p>
      </footer>
    </div>
